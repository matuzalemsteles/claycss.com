...
<div class="row">
	...
	<div class="col-md-4">
		<div class="card card-type-asset">
			<div class="aspect-ratio bg-checkered card-item-first">
				...
				<span class="sticker sticker-bottom-left sticker-danger">SVG</span>
			</div>
			<div class="card-body">
				<div class="card-row">
					<div class="flex-col flex-col-expand">
				...
				<div class="aspect-ratio-item-center-middle aspect-ratio-item-fluid">
					<span class="sticker">
						<svg aria-hidden="true" class="lexicon-icon lexicon-icon-web-content">
							<use xlink:href="/vendor/lexicon/icons.svg#web-content" />
						</svg>
					</span>
				</div>
				<span class="sticker sticker-bottom-left sticker-danger">SVG</span>
	...
	<div class="col-md-4">
		<div class="card card-type-asset">
			<div class="aspect-ratio card-item-first">
				<div class="aspect-ratio-item-center-middle aspect-ratio-item-fluid">
					<span class="sticker sticker-danger">HS</span>
				</div>
			</div>
			<div class="card-body">
				<div class="card-row">
...
<article id="horizontal-card-with-flex-col-*">
...
<article id="card-row-content-alignment-helpers">
...
<article id="card-helper-classes">
	...
	<div class="col-md-4 col-6">
		<div class="card card-rounded" style="overflow: hidden;">
			...
			<div class="card-body" style="text-align:center;">
				<div class="card-title">Joe Bloggs</div>
				<div class="card-subtitle">Administrator</div>
...
<article id="clickable-checkbox-card">
...
<article id="clickable-radio-card">
